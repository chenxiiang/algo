...
public class Solution215 {
    //后来的提交，既然是优先级队列，为什么还要转化成n-k小，直接第k大不行吗？
    //想下，如果是大顶堆，堆顶元素一定是最大的，怎么知道它是第几大呢？好像不行，还是转化一下比较容易理解
    //设置一个大小为k的小顶堆，大小超出后，每次把堆顶元素移除，当把所有元素过滤完后，剩下的k各元素就是所有元素中最大的k个，而堆顶又是这k个中最小的那个，满足题意
    //如果要用大顶堆，就是要求剩下的n-k个中最大的那个
